    ...
    <div className="auth-page">
      <div className="auth-container">
        ...
        <div className="auth-card">
          ...
          <p className="auth-subtitle">Start recovering your processing fees today</p>
          ...
          <button onClick={handleGoogleSignIn} className="btn btn-secondary btn-full btn-google" disabled={loading}>
