    ...
    <div className="container">
      <div className="hero-content">
        ...
        <div className="hero-buttons">
          <a href="#pricing" className="btn btn-primary btn-large">Start Free Trial</a>
  ...
  <section className="pricing" id="pricing">
    <div className="container">
      <div className="section-header">
        ...
        <p>
          Choose the plan that fits your business. All plans include full compliance automation.
        </p>
      </div>
      <div className="pricing-grid">
        <div className="pricing-card">
          <h3>Starter</h3>
          <div className="price">
            $49<span className="price-period">/month</span>
          </div>
          <p className="pricing-description">
            Perfect for small businesses just getting started with fee recovery.
          </p>
        ...
        <div className="pricing-card featured">
          ...
          <h3>Growth</h3>
          <div className="price">
            $149<span className="price-period">/month</span>
          </div>
          <p className="pricing-description">
            For growing businesses processing higher volumes.
          </p>
          <ul className="pricing-features">
            <li className="pricing-feature">
              <CheckIcon />
...
const CTA = () => (
  <section className="cta">
    <div className="container">
      ...
      <div className="hero-buttons">
        <a href="#pricing" className="btn btn-secondary btn-large">Start Your Free Trial</a>
      </div>
    </div>
  </section>
);
